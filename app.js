...
var Blub = function Blub(canvas) {
  this.canvas = canvas;
  this.ctx = canvas.getContext('2d');
  this.radius = 0;
  this.ringMargin = 30;
  this.maxradius = Math.sqrt(Math.pow(this.canvas.width, 2) + Math.pow(this.canvas.height, 2)) + 1;
};
($traceurRuntime.createClass)(Blub, {tick: function(phase) {
...
},{"../cycles.js":4,"../util.js":6}],4:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
  cos: {get: function() {
      return cos;
...
"use strict";
var $__animations_47_blub_46_js__;
var Blub = ($__animations_47_blub_46_js__ = require("./animations/blub.js"), $__animations_47_blub_46_js__ && $__animations_47_blub_46_js__.__esModule && $__animations_47_blub_46_js__ || {default: $__animations_47_blub_46_js__}).Blub;
var animations = [Blub];
var animSets;
...
function init() {
  ...
  var c;
  for (var $__1 = animations[Symbol.iterator](),
      $__2; !($__2 = $__1.next()).done; ) {
    var animation = $__2.value;
    {
...
function tick() {
  ...
  for (var $__1 = animSets[Symbol.iterator](),
      $__2; !($__2 = $__1.next()).done; ) {
    var set = $__2.value;
    {
...
},{"./animations/blub.js":3}],6:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
  range: {get: function() {
      return range;
