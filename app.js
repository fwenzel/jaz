...
var hsla = ($___46__46__47_util_46_js__ = require("../util.js"), $___46__46__47_util_46_js__ && $___46__46__47_util_46_js__.__esModule && $___46__46__47_util_46_js__ || {default: $___46__46__47_util_46_js__}).hsla;
...
($traceurRuntime.createClass)(Blub, {tick: function(phase) {
    ...
    for (var $__4 = [-this.canvas.width / 4, this.canvas.width * 1 / 4][Symbol.iterator](),
        $__5; !($__5 = $__4.next()).done; ) {
      var x = $__5.value;
      {
        for (var $__2 = [-this.canvas.height / 4, this.canvas.height * 1 / 4][Symbol.iterator](),
            $__3; !($__3 = $__2.next()).done; ) {
          var y = $__3.value;
          {
...
},{"./animations/blub.js":3}],5:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
  range: {get: function() {
      return range;
